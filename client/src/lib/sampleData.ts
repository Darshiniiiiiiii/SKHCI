...
export const defaultNotifications: Notification[] = [
  ...
  {
    id: 'notif-4',
    text: 'Gowtham mentioned you in API integrations discussion',
    timestamp: new Date().toISOString(),
    type: 'mention',
    read: false,
    relatedId: 'group-2',
  ...
  {
    id: 'notif-5',
    text: 'Backend architecture meeting rescheduled',
    timestamp: new Date().toISOString(),
    type: 'meeting',
    read: false,
    relatedId: 'meeting-2',
  ...
  {
    id: 'notif-6',
    text: 'Project status update: Auth system completed',
    timestamp: new Date().toISOString(),
    type: 'update',
    read: false,
    tags: ['auth', 'milestone'],
  ...
  {
    id: 'notif-7',
    text: 'Database schema update approved by lead',
    timestamp: new Date().toISOString(),
    type: 'update',
    read: false,
